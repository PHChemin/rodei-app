...
import { TruckFinancialStatement } from "@/schemas";
...
type TruckFinancialStatementDetailsProps = {
  statement: TruckFinancialStatement;
};

export function TruckFinancialDetails({
  statement,
}: TruckFinancialStatementDetailsProps) {
  const styles = useStyles();

  return (
    <>
      <Text h1 style={{ marginTop: spacing.lg }}>
        {t("components.truck-financial-statement.title")}
      </Text>

      <Flex justify="space-between" gap={spacing.md}>
        <Card containerStyle={styles.card}>
          <Text style={styles.subtitle}>
            {t("components.truck-financial-statement.freights")}
          </Text>
        ...
        <Card containerStyle={styles.card}>
          <Text style={styles.subtitle}>
            {t("components.truck-financial-statement.expenses")}
          </Text>
      ...
      <Flex justify="space-between" gap={spacing.md}>
        <Card containerStyle={styles.card}>
          <Text style={styles.subtitle}>
            {t("components.truck-financial-statement.revenue")}
          </Text>
        ...
        <Card containerStyle={styles.card}>
          <Text style={styles.subtitle}>
            {t("components.truck-financial-statement.costs")}
          </Text>
          <Text style={[styles.text, styles.expense]}>
            R$ {formatNumberBRL(statement.total_costs)}
          </Text>
        </Card>
      </Flex>
      ...
      <Card containerStyle={{ marginBottom: spacing.md }}>
        <Text style={styles.subtitle}>
          {t("components.truck-financial-statement.profit")}
        </Text>
        <Text
          style={[
            styles.text,
      ...
      <Card>
        <Text style={styles.subtitle}>
          {t("components.truck-financial-statement.profit-last-month") +
