...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma contêm as mensagens de erro padrões utilizadas
    | pela classe validadora. Algumas dessas regras possuem múltiplas versões,
    | como as regras de tamanho. Fique à vontade para ajustar cada mensagem aqui.
    |
    */
    ...
    | Isso permite especificar rapidamente uma mensagem personalizada para
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nosso marcador de
    | posição de atributo por algo mais amigável como "Endereço de E-Mail"
    | ao invés de "email". Isso nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
